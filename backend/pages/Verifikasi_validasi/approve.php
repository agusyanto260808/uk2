...
if (isset($_GET['id'])) {
    ...
    // Update status ke "Terima"
    $sql = "UPDATE pemesanan SET status_pemesanan='Terima' WHERE id_pemesanan=?";
    ...
    if ($stmt->execute()) {
        ...
        $keterangan = "Admin ID $user_id menyetujui pemesanan dengan ID $id (Terima).";
        ...
        echo "<script>
            alert('Pemesanan berhasil diverifikasi (Terima)!');
